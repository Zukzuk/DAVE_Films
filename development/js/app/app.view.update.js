...
$.extend(ViewUpdate.prototype,
{
	...
	default_page_update : function(data)
	{
		...
		if (app.model.current_page != 'login')
	...
	add_flash : function(data)
	{
		...
		swfobject.embedSWF(app.model.base_url + "swf/" + app.swf_name + ".swf", //flash_output_file.swf
		"altContent", app.width, app.height, app.version, //"11.0.0",
		app.model.base_url + "swf/expressInstall.swf", flashvars, params, attributes);
