...
$.extend(Model.prototype,
{
	...
	setup_routing : function(deeplink)
	{
		...
		for ( i = 0; i < this.filter_types.length; i++)
		{
			...
			for ( j = 1; j < deeplink.pathNames.length; j++)
			{
				...
				if ( typeof active_filters[filter_type] != 'undefined')
				{
	...
	setup_device : function()
	{
		...
		if (this.window_size[0] > this.device.mobile_small && this.window_size[0] <= this.device.mobile && this.device.type != 'mobile')
		{
