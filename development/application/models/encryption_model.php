...
class Encryption_model extends CI_Model
{
	...
	{ 
		...
		$session_key = "4%tGbNMj87&9o_2D";					// RANDOMIZE!!
		$flash_key = "l(u%tGhF4E#7Jk!M"; 					// DUPLICATE IN FLASH!!
		$highscore_key = "98&jhJKkMHfr^%4y"; 				// RANDOMIZE!!		
		$session_secret = "some_unique_session_secret"; 	// getGUID !!
